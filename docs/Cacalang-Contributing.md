...
Run from `cacalang/`. Requires the [.NET 10 SDK](https://dotnet.microsoft.com/download). Warnings are
errors.
...
3. **Type rules** in `Binding/TypeChecker.cs`, and a new
   ...
   at the end; they appear in editor output and in [Cacalang-Diagnostics](Cacalang-Diagnostics).
...
9. **Documentation**: [Cacalang-Grammar](Cacalang-Grammar) and
   [Cacalang-Language](Cacalang-Language), plus
   [Cacalang-Diagnostics](Cacalang-Diagnostics) for any new code.
