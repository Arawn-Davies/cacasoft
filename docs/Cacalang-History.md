...
run reports everything it can find. See [`Cacalang-Diagnostics.md`](Cacalang-Diagnostics).
...
concatenation. [`Cacalang-Language.md`](Cacalang-Language) covers all of it.
