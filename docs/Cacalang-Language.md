...
[`Cacalang-Grammar.md`](Cacalang-Grammar); this is the readable version.
...
against any assembly passed to the CLI with [`--ref`](Cacalang-CLI), which is how a
...
[`samples/shell.caca`](../cacalang/samples/shell.caca) is a small command shell built
this way, and [`samples/interop`](../cacalang/samples/interop) binds to a C# library.
